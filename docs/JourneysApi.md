...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    create_journey_alpha_input = {"name":"Application Abandonment","description":"Calls users who abandon an application within 20 minutes","definition":{"initial":"entry_abc123","states":{"entry_abc123":{"meta":{"type":"entry","name":"Application Started","event":{"type":"ast","options":{"AND":[{"event":"Application Started"}]}}},"on":{"hold_abc123":{"target":"hold_abc123"}}},"hold_abc123":{"meta":{"type":"split","name":"Wait for Application Finished","splitType":"event","delay":{"duration":20,"durationUnits":"minutes"}},"on":{"completed_abc123":{"target":"exit_completed_abc123"},"timeout_abc123":{"target":"exit_timeout_abc123"}}},"exit_completed_abc123":{"meta":{"type":"exit","name":"Completed"}},"exit_timeout_abc123":{"meta":{"type":"exit","name":"Timed Out"}}},"entryRules":{"type":"multiple"}}} # CreateJourneyAlphaInput | 
