# segment_public_api.SpaceSchemaAPIApi

All URIs are relative to *https://api.segmentapis.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_entity_paths**](SpaceSchemaAPIApi.md#list_entity_paths) | **GET** /spaces/{spaceId}/entity-paths | List Entity Paths
[**list_events**](SpaceSchemaAPIApi.md#list_events) | **GET** /spaces/{spaceId}/events | List Events
[**list_properties_from_entity**](SpaceSchemaAPIApi.md#list_properties_from_entity) | **GET** /spaces/{spaceId}/entities/{entitySlug}/properties | List Properties from Entity
[**list_properties_from_event**](SpaceSchemaAPIApi.md#list_properties_from_event) | **GET** /spaces/{spaceId}/events/{eventName}/properties | List Properties from Event
[**list_sample_values_from_entity_property**](SpaceSchemaAPIApi.md#list_sample_values_from_entity_property) | **GET** /spaces/{spaceId}/entities/{entitySlug}/properties/{propertyName}/sample-values | List Sample Values from Entity Property
[**list_sample_values_from_event_property**](SpaceSchemaAPIApi.md#list_sample_values_from_event_property) | **GET** /spaces/{spaceId}/events/{eventName}/properties/{propertyName}/sample-values | List Sample Values from Event Property
[**list_sample_values_from_trait**](SpaceSchemaAPIApi.md#list_sample_values_from_trait) | **GET** /spaces/{spaceId}/traits/{traitKey}/sample-values | List Sample Values from Trait
[**list_traits**](SpaceSchemaAPIApi.md#list_traits) | **GET** /spaces/{spaceId}/traits | List Traits
...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    api_instance = segment_public_api.SpaceSchemaAPIApi(api_client)
    ...
    try:
        ...
        print("The response of SpaceSchemaAPIApi->list_entity_paths:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpaceSchemaAPIApi->list_entity_paths: %s\n" % e)
```
...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SpaceSchemaAPIApi->list_events:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpaceSchemaAPIApi->list_events: %s\n" % e)
```
...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SpaceSchemaAPIApi->list_properties_from_entity:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpaceSchemaAPIApi->list_properties_from_entity: %s\n" % e)
```
...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SpaceSchemaAPIApi->list_properties_from_event:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpaceSchemaAPIApi->list_properties_from_event: %s\n" % e)
```
...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SpaceSchemaAPIApi->list_sample_values_from_entity_property:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpaceSchemaAPIApi->list_sample_values_from_entity_property: %s\n" % e)
```
...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SpaceSchemaAPIApi->list_sample_values_from_event_property:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpaceSchemaAPIApi->list_sample_values_from_event_property: %s\n" % e)
```
...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SpaceSchemaAPIApi->list_sample_values_from_trait:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpaceSchemaAPIApi->list_sample_values_from_trait: %s\n" % e)
```
...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SpaceSchemaAPIApi->list_traits:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SpaceSchemaAPIApi->list_traits: %s\n" % e)
```
