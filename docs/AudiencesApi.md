...
with segment_public_api.ApiClient(configuration) as api_client:
    ...
    create_audience_beta_input = {"name":"name","description":"description","enabled":false,"productVariant":"USERS","computeConditionsWrapper":{"format":"CQL","conditions":"event('Shoes Bought').count() >= 1"},"options":{"includeHistoricalData":true}} # CreateAudienceBetaInput | 
