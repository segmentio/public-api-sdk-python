...
class AudiencesApi:
    ...
    def get_audience_echo(self, space_id : constr(strict=True), message : Annotated[Optional[StrictStr], Field(description="Optional message to echo back.  This parameter exists in alpha.")] = None, **kwargs) -> GetAudienceEcho200Response:  # noqa: E501
        ...
        >>> thread = api.get_audience_echo(space_id, message, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetAudienceEcho200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_audience_echo_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_audience_echo_with_http_info(space_id, message, **kwargs)  # noqa: E501
    ...
    def get_audience_echo_with_http_info(self, space_id : constr(strict=True), message : Annotated[Optional[StrictStr], Field(description="Optional message to echo back.  This parameter exists in alpha.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_audience_echo_with_http_info(space_id, message, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetAudienceEcho200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_audience_echo" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetAudienceEcho200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
        ...
        return self.api_client.call_api(
            '/spaces/{spaceId}/audiences/echo', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
