...
class WarehousesApi:
    ...
    @validate_arguments
    def add_connection_from_source_to_warehouse(self, warehouse_id : constr(strict=True), source_id : constr(strict=True), **kwargs) -> AddConnectionFromSourceToWarehouse200Response:  # noqa: E501
        ...
        :rtype: AddConnectionFromSourceToWarehouse200Response
        """
    ...
    def add_connection_from_source_to_warehouse_with_http_info(self, warehouse_id : constr(strict=True), source_id : constr(strict=True), **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AddConnectionFromSourceToWarehouse200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "AddConnectionFromSourceToWarehouse200Response",
    ...
    @validate_arguments
    def create_warehouse(self, create_warehouse_v1_input : CreateWarehouseV1Input, **kwargs) -> CreateWarehouse200Response:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CreateWarehouse200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def create_warehouse_with_http_info(self, create_warehouse_v1_input : CreateWarehouseV1Input, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateWarehouse200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "CreateWarehouse200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
