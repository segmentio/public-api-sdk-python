...
class DestinationsApi:
    ...
    def create_destination_subscription(self, destination_id : constr(strict=True), create_destination_subscription_alpha_input : CreateDestinationSubscriptionAlphaInput, **kwargs) -> CreateDestinationSubscription200Response:  # noqa: E501
        ...
        Creates a new Destination subscription.  • This endpoint is in **Alpha** testing.  Please submit any feedback by sending email to friends@segment.com.   • In order to successfully call this endpoint, the specified Workspace needs to have the Destination Subscriptions feature enabled. Please reach out to your customer success manager for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_subscription_from_destination(self, destination_id : constr(strict=True), id : constr(strict=True), **kwargs) -> GetSubscriptionFromDestination200Response:  # noqa: E501
        ...
        Gets a Destination subscription by id.  • This endpoint is in **Alpha** testing.  Please submit any feedback by sending email to friends@segment.com.   • In order to successfully call this endpoint, the specified Workspace needs to have the Destination Subscriptions feature enabled. Please reach out to your customer success manager for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def list_destinations(self, pagination : Annotated[PaginationInput, Field(..., description="Required pagination params for the request.  This parameter exists in v1.")], **kwargs) -> ListDestinations200Response:  # noqa: E501
        ...
        :param pagination: Required pagination params for the request.  This parameter exists in v1. (required)
    ...
    @validate_arguments
    def list_destinations_with_http_info(self, pagination : Annotated[PaginationInput, Field(..., description="Required pagination params for the request.  This parameter exists in v1.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List Destinations  # noqa: E501
    ...
    @validate_arguments
    def list_subscriptions_from_destination(self, destination_id : constr(strict=True), pagination : Annotated[PaginationInput, Field(..., description="Pagination options.  This parameter exists in alpha.")], **kwargs) -> ListSubscriptionsFromDestination200Response:  # noqa: E501
        """List Subscriptions from Destination  # noqa: E501

        Lists subscriptions for a Destination.  • This endpoint is in **Alpha** testing.  Please submit any feedback by sending email to friends@segment.com.   • In order to successfully call this endpoint, the specified Workspace needs to have the Destination Subscriptions feature enabled. Please reach out to your customer success manager for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def list_subscriptions_from_destination_with_http_info(self, destination_id : constr(strict=True), pagination : Annotated[PaginationInput, Field(..., description="Pagination options.  This parameter exists in alpha.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List Subscriptions from Destination  # noqa: E501
    ...
    def remove_subscription_from_destination(self, destination_id : constr(strict=True), id : constr(strict=True), **kwargs) -> RemoveSubscriptionFromDestination200Response:  # noqa: E501
        ...
        Deletes an existing Destination subscription.  • This endpoint is in **Alpha** testing.  Please submit any feedback by sending email to friends@segment.com.   • In order to successfully call this endpoint, the specified Workspace needs to have the Destination Subscriptions feature enabled. Please reach out to your customer success manager for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_subscription_for_destination(self, destination_id : constr(strict=True), id : constr(strict=True), update_subscription_for_destination_alpha_input : UpdateSubscriptionForDestinationAlphaInput, **kwargs) -> UpdateSubscriptionForDestination200Response:  # noqa: E501
        ...
        Updates an existing Destination subscription.  • This endpoint is in **Alpha** testing.  Please submit any feedback by sending email to friends@segment.com.   • In order to successfully call this endpoint, the specified Workspace needs to have the Destination Subscriptions feature enabled. Please reach out to your customer success manager for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
