...
class CredentialsApi:
    ...
    def create_credential(
        self,
        create_credential_v1_input: CreateCredentialV1Input,
        ...
        _param = self._create_credential_serialize(
            create_credential_v1_input=create_credential_v1_input,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateCredential201Response",
    ...
    def _create_credential_serialize(
        ...
        if create_credential_v1_input is not None:
            _body_params = create_credential_v1_input
    ...
    def delete_credential(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteCredential200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
    ...
    def _delete_credential_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/credentials/{credentialId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_credential_consumers(
        self,
        credential_id: Annotated[str, Field(strict=True)],
        warehouses_pagination: Annotated[Optional[PaginationInput], Field(description="Defines the pagination parameters for the list of Warehouses.  This parameter exists in v1.")] = None,
        sources_pagination: Annotated[Optional[PaginationInput], Field(description="Defines the pagination parameters for the list of Sources.  This parameter exists in v1.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param credential_id: (required)
        :type credential_id: str
        :param warehouses_pagination: Defines the pagination parameters for the list of Warehouses.  This parameter exists in v1.
        :type warehouses_pagination: PaginationInput
        :param sources_pagination: Defines the pagination parameters for the list of Sources.  This parameter exists in v1.
        :type sources_pagination: PaginationInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._list_credential_consumers_serialize(
            credential_id=credential_id,
            warehouses_pagination=warehouses_pagination,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListCredentialConsumers200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
    ...
    @validate_call
    def list_credential_consumers_with_http_info(
        self,
        credential_id: Annotated[str, Field(strict=True)],
        warehouses_pagination: Annotated[Optional[PaginationInput], Field(description="Defines the pagination parameters for the list of Warehouses.  This parameter exists in v1.")] = None,
        sources_pagination: Annotated[Optional[PaginationInput], Field(description="Defines the pagination parameters for the list of Sources.  This parameter exists in v1.")] = None,
    ...
    @validate_call
    def list_credential_consumers_without_preload_content(
        self,
        credential_id: Annotated[str, Field(strict=True)],
        warehouses_pagination: Annotated[Optional[PaginationInput], Field(description="Defines the pagination parameters for the list of Warehouses.  This parameter exists in v1.")] = None,
        sources_pagination: Annotated[Optional[PaginationInput], Field(description="Defines the pagination parameters for the list of Sources.  This parameter exists in v1.")] = None,
    ...
    def _list_credential_consumers_serialize(
        self,
        credential_id,
        ...
        if credential_id is not None:
            _path_params['credentialId'] = credential_id
        # process the query parameters
        if warehouses_pagination is not None:
            
            _query_params.append(('warehousesPagination', warehouses_pagination))
            
        if sources_pagination is not None:
            
            _query_params.append(('sourcesPagination', sources_pagination))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/credentials/{credentialId}/consumers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_credentials(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListCredentials200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
    ...
    def update_credential(
        self,
        credential_id: Annotated[str, Field(strict=True)],
        update_credential_v1_input: UpdateCredentialV1Input,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param credential_id: (required)
        :type credential_id: str
        :param update_credential_v1_input: (required)
        :type update_credential_v1_input: UpdateCredentialV1Input
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_credential_serialize(
            credential_id=credential_id,
            update_credential_v1_input=update_credential_v1_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateCredential200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
    ...
    def _update_credential_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_credential_v1_input is not None:
            _body_params = update_credential_v1_input
