...
class ReverseETLApi:
    ...
    @validate_arguments
    def get_reverse_etl_sync_from_model(self, model_id : constr(strict=True), sync_id : constr(strict=True), **kwargs) -> GetReverseETLSyncFromModel200Response:  # noqa: E501
        """Get Reverse ETL Sync from Model  # noqa: E501
        ...
        >>> thread = api.get_reverse_etl_sync_from_model(model_id, sync_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetReverseETLSyncFromModel200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_reverse_etl_sync_from_model_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_reverse_etl_sync_from_model_with_http_info(model_id, sync_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_reverse_etl_sync_from_model_with_http_info(self, model_id : constr(strict=True), sync_id : constr(strict=True), **kwargs) -> ApiResponse:  # noqa: E501
        """Get Reverse ETL Sync from Model  # noqa: E501
        ...
        >>> thread = api.get_reverse_etl_sync_from_model_with_http_info(model_id, sync_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetReverseETLSyncFromModel200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reverse_etl_sync_from_model" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetReverseETLSyncFromModel200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
