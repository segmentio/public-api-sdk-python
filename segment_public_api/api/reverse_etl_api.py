...
class ReverseETLApi:
    ...
    @validate_arguments
    def get_reverse_etl_sync_statuses_by_subscription_id(self, model_id : constr(strict=True), subscription_id : constr(strict=True), pagination : Annotated[Optional[PaginationInput], Field(description="Optional pagination params.  This parameter exists in alpha.")] = None, **kwargs) -> GetReverseETLSyncStatusesBySubscriptionId200Response:  # noqa: E501
        """Get Reverse ETL Sync Statuses By Subscription Id  # noqa: E501
        ...
        >>> thread = api.get_reverse_etl_sync_statuses_by_subscription_id(model_id, subscription_id, pagination, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetReverseETLSyncStatusesBySubscriptionId200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_reverse_etl_sync_statuses_by_subscription_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_reverse_etl_sync_statuses_by_subscription_id_with_http_info(model_id, subscription_id, pagination, **kwargs)  # noqa: E501

    @validate_arguments
    def get_reverse_etl_sync_statuses_by_subscription_id_with_http_info(self, model_id : constr(strict=True), subscription_id : constr(strict=True), pagination : Annotated[Optional[PaginationInput], Field(description="Optional pagination params.  This parameter exists in alpha.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Reverse ETL Sync Statuses By Subscription Id  # noqa: E501
        ...
        >>> thread = api.get_reverse_etl_sync_statuses_by_subscription_id_with_http_info(model_id, subscription_id, pagination, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetReverseETLSyncStatusesBySubscriptionId200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_reverse_etl_sync_statuses_by_subscription_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetReverseETLSyncStatusesBySubscriptionId200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
