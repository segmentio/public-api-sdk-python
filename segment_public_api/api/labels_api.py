...
class LabelsApi:
    ...
    @validate_arguments
    def create_label(self, create_label_v1_input : CreateLabelV1Input, **kwargs) -> CreateLabel200Response:  # noqa: E501
    ...
    def create_label_with_http_info(self, create_label_v1_input : CreateLabelV1Input, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateLabel200Response, status_code(int), headers(HTTPHeaderDict))
        """
