...
class SourcesApi:
    ...
    @validate_arguments
    def create_source(self, create_source_v1_input : CreateSourceV1Input, **kwargs) -> CreateSource200Response:  # noqa: E501
    ...
    def create_source_with_http_info(self, create_source_v1_input : CreateSourceV1Input, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateSource200Response, status_code(int), headers(HTTPHeaderDict))
        """
