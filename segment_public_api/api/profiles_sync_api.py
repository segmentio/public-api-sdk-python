...
class ProfilesSyncApi:
    ...
    @validate_arguments
    def create_profiles_warehouse(self, space_id : constr(strict=True), create_profiles_warehouse_alpha_input : CreateProfilesWarehouseAlphaInput, **kwargs) -> CreateProfilesWarehouse200Response:  # noqa: E501
        ...
        :rtype: CreateProfilesWarehouse200Response
        """
    ...
    def create_profiles_warehouse_with_http_info(self, space_id : constr(strict=True), create_profiles_warehouse_alpha_input : CreateProfilesWarehouseAlphaInput, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateProfilesWarehouse200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "CreateProfilesWarehouse200Response",
