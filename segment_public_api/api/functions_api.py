...
class FunctionsApi:
    ...
    @validate_arguments
    def create_transformation_function_instance(self, create_transformation_function_instance_alpha_input : CreateTransformationFunctionInstanceAlphaInput, **kwargs) -> CreateTransformationFunctionInstance200Response:  # noqa: E501
        """Create Transformation Function Instance  # noqa: E501

        Creates a Transformation Function instance connected to the given Integration.  This endpoint is specifically designed for Transformations and includes integration_type as a mandatory field.    • In order to successfully call this endpoint, the specified Workspace needs to have the Functions feature enabled. Please reach out to your customer success manager for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_transformation_function_instance(create_transformation_function_instance_alpha_input, async_req=True)
        >>> result = thread.get()

        :param create_transformation_function_instance_alpha_input: (required)
        :type create_transformation_function_instance_alpha_input: CreateTransformationFunctionInstanceAlphaInput
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CreateTransformationFunctionInstance200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_transformation_function_instance_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_transformation_function_instance_with_http_info(create_transformation_function_instance_alpha_input, **kwargs)  # noqa: E501

    @validate_arguments
    def create_transformation_function_instance_with_http_info(self, create_transformation_function_instance_alpha_input : CreateTransformationFunctionInstanceAlphaInput, **kwargs) -> ApiResponse:  # noqa: E501
        """Create Transformation Function Instance  # noqa: E501
        ...
        >>> thread = api.create_transformation_function_instance_with_http_info(create_transformation_function_instance_alpha_input, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateTransformationFunctionInstance200Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_transformation_function_instance_alpha_input'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_transformation_function_instance" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['create_transformation_function_instance_alpha_input'] is not None:
            _body_params = _params['create_transformation_function_instance_alpha_input']
        ...
        _response_types_map = {
            '200': "CreateTransformationFunctionInstance200Response",
            '404': "RequestErrorEnvelope",
            '422': "RequestErrorEnvelope",
            '429': "RequestErrorEnvelope",
        }
        ...
        return self.api_client.call_api(
            '/transformation-function-instances', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
