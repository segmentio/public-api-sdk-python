...
class AuditTrailApi:
    ...
    def list_audit_events(self, pagination : Annotated[PaginationInput, Field(..., description="Defines the pagination parameters.  This parameter exists in v1.")], start_time : Annotated[Optional[StrictStr], Field(description="Filter response to events that happened after this time.  This parameter exists in v1.")] = None, end_time : Annotated[Optional[StrictStr], Field(description="Filter response to events that happened before this time. Defaults to the current time, or the end time from the pagination cursor.  This parameter exists in v1.")] = None, resource_id : Annotated[Optional[StrictStr], Field(description="Filter response to events that affect a specific resource, for example, a single Source.  This parameter exists in v1.")] = None, resource_type : Annotated[Optional[StrictStr], Field(description="Filter response to events that affect a specific type, for example, Sources, Warehouses, and Tracking Plans.  This parameter exists in v1.")] = None, **kwargs) -> ListAuditEvents200Response:  # noqa: E501
        ...
        >>> thread = api.list_audit_events(pagination, start_time, end_time, resource_id, resource_type, async_req=True)
        >>> result = thread.get()
        ...
        return self.list_audit_events_with_http_info(pagination, start_time, end_time, resource_id, resource_type, **kwargs)  # noqa: E501

    @validate_arguments
    def list_audit_events_with_http_info(self, pagination : Annotated[PaginationInput, Field(..., description="Defines the pagination parameters.  This parameter exists in v1.")], start_time : Annotated[Optional[StrictStr], Field(description="Filter response to events that happened after this time.  This parameter exists in v1.")] = None, end_time : Annotated[Optional[StrictStr], Field(description="Filter response to events that happened before this time. Defaults to the current time, or the end time from the pagination cursor.  This parameter exists in v1.")] = None, resource_id : Annotated[Optional[StrictStr], Field(description="Filter response to events that affect a specific resource, for example, a single Source.  This parameter exists in v1.")] = None, resource_type : Annotated[Optional[StrictStr], Field(description="Filter response to events that affect a specific type, for example, Sources, Warehouses, and Tracking Plans.  This parameter exists in v1.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List Audit Events  # noqa: E501
        ...
        >>> thread = api.list_audit_events_with_http_info(pagination, start_time, end_time, resource_id, resource_type, async_req=True)
        >>> result = thread.get()
