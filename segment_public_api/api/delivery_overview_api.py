...
class DeliveryOverviewApi:
    ...
    @validate_arguments
    def get_egress_success_metrics_from_delivery_overview(self, source_id : Annotated[StrictStr, Field(..., description="The sourceId for the Workspace.  This parameter exists in beta.")], destination_config_id : Annotated[StrictStr, Field(..., description="The id tied to a Workspace Destination.  This parameter exists in beta.")], start_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in beta.")], end_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in beta.")], granularity : Annotated[StrictStr, Field(..., description="The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta.")], group_by : Annotated[Optional[conlist(StrictStr)], Field(description="A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, `appVersion`, `subscriptionId`, `activationId`, `audienceId`, and `spaceId`.  This parameter exists in beta.")] = None, filter : Annotated[Optional[DeliveryOverviewDestinationFilterBy], Field(description="An optional filter for `eventName`, `eventType`, `discardReason`, `appVersion`, `subscriptionId`, `activationId`, `audienceId`, or `spaceId` that can be applied in addition to a `groupBy`. If you would like to view retry attempts for a successful delivery, you can filter `discardReason` from `successes.attempt.1` through `successes.attempt.10`.  This parameter exists in beta.")] = None, pagination : Annotated[Optional[PaginationInput], Field(description="Params to specify the page cursor and count.  This parameter exists in beta.")] = None, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        :param group_by: A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, `appVersion`, `subscriptionId`, `activationId`, `audienceId`, and `spaceId`.  This parameter exists in beta.
        :type group_by: List[str]
        :param filter: An optional filter for `eventName`, `eventType`, `discardReason`, `appVersion`, `subscriptionId`, `activationId`, `audienceId`, or `spaceId` that can be applied in addition to a `groupBy`. If you would like to view retry attempts for a successful delivery, you can filter `discardReason` from `successes.attempt.1` through `successes.attempt.10`.  This parameter exists in beta.
        :type filter: DeliveryOverviewDestinationFilterBy
        :param pagination: Params to specify the page cursor and count.  This parameter exists in beta.
        :type pagination: PaginationInput
        :param async_req: Whether to execute the request asynchronously.
    ...
    def get_filtered_at_destination_metrics_from_delivery_overview(self, source_id : Annotated[StrictStr, Field(..., description="The sourceId for the Workspace.  This parameter exists in beta.")], destination_config_id : Annotated[StrictStr, Field(..., description="The id tied to a Workspace Destination.  This parameter exists in beta.")], start_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in beta.")], end_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in beta.")], granularity : Annotated[StrictStr, Field(..., description="The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta.")], group_by : Annotated[Optional[conlist(StrictStr)], Field(description="A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, `appVersion`, and `subscriptionId`, `activationId`, `audienceId`, and `spaceId`.  This parameter exists in beta.")] = None, filter : Annotated[Optional[DeliveryOverviewDestinationFilterBy], Field(description="An optional filter for `eventName`, `eventType`, `discardReason`, `appVersion`, `subscriptionId`, `activationId`, `audienceId`, and/or `spaceId` that can be applied in addition to a `groupBy`.  This parameter exists in beta.")] = None, pagination : Annotated[Optional[PaginationInput], Field(description="Params to specify the page cursor and count.  This parameter exists in beta.")] = None, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        :param granularity: The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta. (required)
        :type granularity: str
        :param group_by: A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, `appVersion`, and `subscriptionId`, `activationId`, `audienceId`, and `spaceId`.  This parameter exists in beta.
        :type group_by: List[str]
        :param filter: An optional filter for `eventName`, `eventType`, `discardReason`, `appVersion`, `subscriptionId`, `activationId`, `audienceId`, and/or `spaceId` that can be applied in addition to a `groupBy`.  This parameter exists in beta.
        :type filter: DeliveryOverviewDestinationFilterBy
        :param pagination: Params to specify the page cursor and count.  This parameter exists in beta.
    ...
    @validate_arguments
    def get_filtered_at_source_metrics_from_delivery_overview(self, source_id : Annotated[StrictStr, Field(..., description="The sourceId for the Workspace.  This parameter exists in beta.")], start_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in beta.")], end_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in beta.")], granularity : Annotated[StrictStr, Field(..., description="The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta.")], group_by : Annotated[Optional[conlist(StrictStr)], Field(description="A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, `appVersion` `activationId`, `audienceId`, and `spaceId`, .  This parameter exists in beta.")] = None, filter : Annotated[Optional[DeliveryOverviewSourceFilterBy], Field(description="An optional filter for `eventName`, `eventType`, `discardReason`, `appVersion`, `activationId`, `audienceId`, and/or `spaceId` that can be applied in addition to a `groupBy`.  This parameter exists in beta.")] = None, pagination : Annotated[Optional[PaginationInput], Field(description="Optional params to specify the page cursor and count.  This parameter exists in beta.")] = None, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        :param granularity: The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta. (required)
        :type granularity: str
        :param group_by: A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, `appVersion` `activationId`, `audienceId`, and `spaceId`, .  This parameter exists in beta.
        :type group_by: List[str]
        :param filter: An optional filter for `eventName`, `eventType`, `discardReason`, `appVersion`, `activationId`, `audienceId`, and/or `spaceId` that can be applied in addition to a `groupBy`.  This parameter exists in beta.
    ...
    @validate_arguments
    def get_ingress_failed_metrics_from_delivery_overview(self, source_id : Annotated[StrictStr, Field(..., description="The sourceId for the Workspace.  This parameter exists in beta.")], start_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in beta.")], end_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in beta.")], granularity : Annotated[StrictStr, Field(..., description="The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta.")], group_by : Annotated[Optional[conlist(StrictStr)], Field(description="A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, `appVersion`,`activationId`, `audienceId`, and/or `spaceId`.  This parameter exists in beta.")] = None, filter : Annotated[Optional[DeliveryOverviewSourceFilterBy], Field(description="An optional filter for `eventName`, `eventType`, `discardReason`, `appVersion`, `activationId`, `audienceId`, and/or `spaceId` that can be applied in addition to a `groupBy`.  This parameter exists in beta.")] = None, pagination : Annotated[Optional[PaginationInput], Field(description="Optional params to specify the page cursor and count.  This parameter exists in beta.")] = None, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        :param granularity: The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta. (required)
        :type granularity: str
        :param group_by: A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, `appVersion`,`activationId`, `audienceId`, and/or `spaceId`.  This parameter exists in beta.
        :type group_by: List[str]
        :param filter: An optional filter for `eventName`, `eventType`, `discardReason`, `appVersion`, `activationId`, `audienceId`, and/or `spaceId` that can be applied in addition to a `groupBy`.  This parameter exists in beta.
        :type filter: DeliveryOverviewSourceFilterBy
        :param pagination: Optional params to specify the page cursor and count.  This parameter exists in beta.
    ...
    @validate_arguments
    def get_ingress_success_metrics_from_delivery_overview(self, source_id : Annotated[StrictStr, Field(..., description="The sourceId for the Workspace.  This parameter exists in beta.")], start_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in beta.")], end_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in beta.")], granularity : Annotated[StrictStr, Field(..., description="The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta.")], group_by : Annotated[Optional[conlist(StrictStr)], Field(description="A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `appVersion`, `activationId`, `audienceId`, and `spaceId`.  This parameter exists in beta.")] = None, filter : Annotated[Optional[DeliveryOverviewSuccessfullyReceivedFilterBy], Field(description="An optional filter for `eventName`, `eventType`, `appVersion`, `activationId`, `audienceId`, and/or `spaceId` that can be applied in addition to a `groupBy`.  This parameter exists in beta.")] = None, pagination : Annotated[Optional[PaginationInput], Field(description="Optional params to specify the page cursor and count.  This parameter exists in beta.")] = None, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        :param granularity: The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in beta. (required)
        :type granularity: str
        :param group_by: A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `appVersion`, `activationId`, `audienceId`, and `spaceId`.  This parameter exists in beta.
        :type group_by: List[str]
        :param filter: An optional filter for `eventName`, `eventType`, `appVersion`, `activationId`, `audienceId`, and/or `spaceId` that can be applied in addition to a `groupBy`.  This parameter exists in beta.
