...
class DeliveryOverviewApi:
    ...
    @validate_arguments
    def get_egress_failed_metrics_from_delivery_overview(self, source_id : Annotated[StrictStr, Field(..., description="The sourceId for the workspace.  This parameter exists in alpha.")], destination_config_id : Annotated[StrictStr, Field(..., description="The ID tied to a workspace destination. DestinationConfigId is required for Filtered at Destination, Failed Delivery, and Successful Delivery steps.  This parameter exists in alpha.")], start_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in alpha.")], end_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in alpha.")], granularity : Annotated[StrictStr, Field(..., description="The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in alpha.")], pagination : Annotated[PaginationInput, Field(..., description="Params to specify the page cursor and count.  This parameter exists in alpha.")], group_by : Annotated[Optional[conlist(conlist(StrictStr))], Field(description="A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, and `appVersion`.  This parameter exists in alpha.")] = None, filter : Annotated[Optional[DeliveryOverviewFilterBy], Field(description="An optional filter for `eventName`, `eventType`, `discardReason`, and/or `appVersion` that can be applied in addition to a `groupBy`. Example: `filter: {discardReason: ['discard1'], eventName: ['name1', 'name2'], eventType: ['type1']}`.  This parameter exists in alpha.")] = None, subscription_id : Annotated[Optional[StrictStr], Field(description="An optional filter for actions destinations, to filter by a specific action.  This parameter exists in alpha.")] = None, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        :param source_id: The sourceId for the workspace.  This parameter exists in alpha. (required)
        :type source_id: str
        :param destination_config_id: The ID tied to a workspace destination. DestinationConfigId is required for Filtered at Destination, Failed Delivery, and Successful Delivery steps.  This parameter exists in alpha. (required)
        :type destination_config_id: str
        :param start_time: The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in alpha. (required)
        :type start_time: str
        :param end_time: The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in alpha. (required)
        :type end_time: str
        :param granularity: The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in alpha. (required)
        :type granularity: str
        :param pagination: Params to specify the page cursor and count.  This parameter exists in alpha. (required)
        :type pagination: PaginationInput
        :param group_by: A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, and `appVersion`.  This parameter exists in alpha.
        ...
        :param subscription_id: An optional filter for actions destinations, to filter by a specific action.  This parameter exists in alpha.
    ...
    @validate_arguments
    def get_egress_success_metrics_from_delivery_overview(self, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        >>> thread = api.get_egress_success_metrics_from_delivery_overview(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_egress_success_metrics_from_delivery_overview_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_egress_success_metrics_from_delivery_overview_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Egress Success Metrics from Delivery Overview  # noqa: E501
        ...
        >>> thread = api.get_egress_success_metrics_from_delivery_overview_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_filtered_at_destination_metrics_from_delivery_overview(self, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        >>> thread = api.get_filtered_at_destination_metrics_from_delivery_overview(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_filtered_at_destination_metrics_from_delivery_overview_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_filtered_at_destination_metrics_from_delivery_overview_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Filtered At Destination Metrics from Delivery Overview  # noqa: E501
        ...
        >>> thread = api.get_filtered_at_destination_metrics_from_delivery_overview_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_filtered_at_source_metrics_from_delivery_overview(self, source_id : Annotated[StrictStr, Field(..., description="The sourceId for the workspace.  This parameter exists in alpha.")], start_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in alpha.")], end_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in alpha.")], granularity : Annotated[StrictStr, Field(..., description="The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in alpha.")], pagination : Annotated[PaginationInput, Field(..., description="Optional params to specify the page cursor and count.  This parameter exists in alpha.")], destination_config_id : Annotated[Optional[StrictStr], Field(description="The ID tied to a workspace destination.  This parameter exists in alpha.")] = None, group_by : Annotated[Optional[conlist(conlist(StrictStr))], Field(description="A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, and `appVersion`.  This parameter exists in alpha.")] = None, filter : Annotated[Optional[DeliveryOverviewFilterBy], Field(description="An optional filter for `eventName`, `eventType`, `discardReason`, and/or `appVersion` that can be applied in addition to a `groupBy`. Example: `filter: {discardReason: ['discard1'], eventName: ['name1', 'name2'], eventType: ['type1']}`.  This parameter exists in alpha.")] = None, subscription_id : Annotated[Optional[StrictStr], Field(description="An optional filter for actions destinations, to filter by a specific action.  This parameter exists in alpha.")] = None, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        >>> thread = api.get_filtered_at_source_metrics_from_delivery_overview(source_id, start_time, end_time, granularity, pagination, destination_config_id, group_by, filter, subscription_id, async_req=True)
        >>> result = thread.get()
        ...
        :param granularity: The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in alpha. (required)
        :type granularity: str
        :param pagination: Optional params to specify the page cursor and count.  This parameter exists in alpha. (required)
        :type pagination: PaginationInput
        :param destination_config_id: The ID tied to a workspace destination.  This parameter exists in alpha.
        :type destination_config_id: str
        :param group_by: A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, and `appVersion`.  This parameter exists in alpha.
        :type group_by: List[str]
        :param filter: An optional filter for `eventName`, `eventType`, `discardReason`, and/or `appVersion` that can be applied in addition to a `groupBy`. Example: `filter: {discardReason: ['discard1'], eventName: ['name1', 'name2'], eventType: ['type1']}`.  This parameter exists in alpha.
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_filtered_at_source_metrics_from_delivery_overview_with_http_info(source_id, start_time, end_time, granularity, pagination, destination_config_id, group_by, filter, subscription_id, **kwargs)  # noqa: E501
    ...
    def get_filtered_at_source_metrics_from_delivery_overview_with_http_info(self, source_id : Annotated[StrictStr, Field(..., description="The sourceId for the workspace.  This parameter exists in alpha.")], start_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the beginning of the requested timeframe, inclusive.  This parameter exists in alpha.")], end_time : Annotated[StrictStr, Field(..., description="The ISO8601 formatted timestamp corresponding to the end of the requested timeframe, noninclusive.  This parameter exists in alpha.")], granularity : Annotated[StrictStr, Field(..., description="The size of each bucket in the requested window.  Based on the granularity chosen, there are restrictions on the time range you can query:  **Minute**: - Max time range: 4 hours - Oldest possible start time: 48 hours in the past  **Hour**: - Max Time range: 14 days - Oldest possible start time: 30 days in the past  **Day**: - Max time range: 30 days - Oldest possible start time: 30 days in the past  This parameter exists in alpha.")], pagination : Annotated[PaginationInput, Field(..., description="Optional params to specify the page cursor and count.  This parameter exists in alpha.")], destination_config_id : Annotated[Optional[StrictStr], Field(description="The ID tied to a workspace destination.  This parameter exists in alpha.")] = None, group_by : Annotated[Optional[conlist(conlist(StrictStr))], Field(description="A comma-delimited list of strings representing one or more dimensions to group the result by.  Valid options are: `eventName`, `eventType`, `discardReason`, and `appVersion`.  This parameter exists in alpha.")] = None, filter : Annotated[Optional[DeliveryOverviewFilterBy], Field(description="An optional filter for `eventName`, `eventType`, `discardReason`, and/or `appVersion` that can be applied in addition to a `groupBy`. Example: `filter: {discardReason: ['discard1'], eventName: ['name1', 'name2'], eventType: ['type1']}`.  This parameter exists in alpha.")] = None, subscription_id : Annotated[Optional[StrictStr], Field(description="An optional filter for actions destinations, to filter by a specific action.  This parameter exists in alpha.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_filtered_at_source_metrics_from_delivery_overview_with_http_info(source_id, start_time, end_time, granularity, pagination, destination_config_id, group_by, filter, subscription_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_ingress_failed_metrics_from_delivery_overview(self, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        >>> thread = api.get_ingress_failed_metrics_from_delivery_overview(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_ingress_failed_metrics_from_delivery_overview_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_ingress_failed_metrics_from_delivery_overview_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Ingress Failed Metrics from Delivery Overview  # noqa: E501
        ...
        >>> thread = api.get_ingress_failed_metrics_from_delivery_overview_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_ingress_success_metrics_from_delivery_overview(self, **kwargs) -> GetEgressFailedMetricsFromDeliveryOverview200Response:  # noqa: E501
        ...
        >>> thread = api.get_ingress_success_metrics_from_delivery_overview(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_ingress_success_metrics_from_delivery_overview_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_ingress_success_metrics_from_delivery_overview_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Ingress Success Metrics from Delivery Overview  # noqa: E501
        ...
        >>> thread = api.get_ingress_success_metrics_from_delivery_overview_with_http_info(async_req=True)
        >>> result = thread.get()
