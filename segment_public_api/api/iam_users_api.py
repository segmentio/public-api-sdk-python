...
class IAMUsersApi:
    ...
    @validate_arguments
    def create_invites(self, create_invites_v1_input : CreateInvitesV1Input, **kwargs) -> CreateInvites200Response:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CreateInvites200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def create_invites_with_http_info(self, create_invites_v1_input : CreateInvitesV1Input, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateInvites200Response, status_code(int), headers(HTTPHeaderDict))
        """
