...
class RunningAudiencePreview(BaseModel):
    """
    Audience preview that is currently being calculated.  # noqa: E501
    """
    ...
    __properties = ["status", "id", "audienceType", "definition", "options"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunningAudiencePreview:
        """Create an instance of RunningAudiencePreview from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunningAudiencePreview:
        """Create an instance of RunningAudiencePreview from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RunningAudiencePreview.parse_obj(obj)

        _obj = RunningAudiencePreview.parse_obj({
