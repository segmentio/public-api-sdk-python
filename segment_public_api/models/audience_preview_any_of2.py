...
class AudiencePreviewAnyOf2(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudiencePreviewAnyOf2:
        """Create an instance of AudiencePreviewAnyOf2 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudiencePreviewAnyOf2:
        """Create an instance of AudiencePreviewAnyOf2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudiencePreviewAnyOf2.parse_obj(obj)

        _obj = AudiencePreviewAnyOf2.parse_obj({
