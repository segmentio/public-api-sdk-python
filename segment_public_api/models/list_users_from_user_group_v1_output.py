...
class ListUsersFromUserGroupV1Output(BaseModel):
    ...
    """ # noqa: E501
    users: List[MinimalUserV1] = Field(description="The users of the user group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [MinimalUserV1.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
