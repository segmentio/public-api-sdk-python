...
class ListAudiencesAlphaOutput(BaseModel):
    ...
    """ # noqa: E501
    audiences: List[AudienceSummaryWithAudienceTypeAndLookback] = Field(description="A list of audience summary results.")
    ...
    __properties: ClassVar[List[str]] = ["audiences", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audiences": [AudienceSummaryWithAudienceTypeAndLookback.from_dict(_item) for _item in obj["audiences"]] if obj.get("audiences") is not None else None,
