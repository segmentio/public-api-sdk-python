...
class WarehouseMetadataV1(BaseModel):
    ...
    logos: LogosBeta = Field(description="Logo information for this object.")
    options: List[IntegrationOptionBeta] = Field(description="The Integration options for this object.")
    __properties: ClassVar[List[str]] = ["id", "name", "slug", "description", "logos", "options"]
