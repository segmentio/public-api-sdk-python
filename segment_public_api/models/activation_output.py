...
class ActivationOutput(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "personalization": PersonalizationOutput.from_dict(obj["personalization"]) if obj.get("personalization") is not None else None,
