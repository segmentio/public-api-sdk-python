...
class AudiencePreviewAnyOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudiencePreviewAnyOf:
        """Create an instance of AudiencePreviewAnyOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudiencePreviewAnyOf:
        """Create an instance of AudiencePreviewAnyOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudiencePreviewAnyOf.parse_obj(obj)

        _obj = AudiencePreviewAnyOf.parse_obj({
