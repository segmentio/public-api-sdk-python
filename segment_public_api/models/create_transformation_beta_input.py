...
class CreateTransformationBetaInput(BaseModel):
    ...
    source_id: StrictStr = Field(description="The Source to be associated with the Transformation.", alias="sourceId")
    destination_metadata_id: Optional[StrictStr] = Field(default=None, description="The optional Destination metadata id to be associated with the Transformation.", alias="destinationMetadataId")
    ...
    __properties: ClassVar[List[str]] = ["name", "sourceId", "destinationMetadataId", "enabled", "if", "newEventName", "propertyRenames", "propertyValueTransformations"]
