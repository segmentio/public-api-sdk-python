...
class MessagesSubscriptionRequest(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The user subscribed, unsubscribed, or on initial status globally.")
    groups: Optional[List[GroupSubscriptionStatus]] = Field(default=None, description="Optional groups subscription status.")
    __properties: ClassVar[List[str]] = ["key", "type", "status", "groups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [GroupSubscriptionStatus.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
