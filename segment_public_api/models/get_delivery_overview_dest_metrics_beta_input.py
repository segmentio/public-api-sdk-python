...
class GetDeliveryOverviewDestMetricsBetaInput(BaseModel):
    """
    Input of the Delivery Overview Destination steps.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDeliveryOverviewDestMetricsBetaInput:
        """Create an instance of GetDeliveryOverviewDestMetricsBetaInput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDeliveryOverviewDestMetricsBetaInput:
        """Create an instance of GetDeliveryOverviewDestMetricsBetaInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDeliveryOverviewDestMetricsBetaInput.parse_obj(obj)

        _obj = GetDeliveryOverviewDestMetricsBetaInput.parse_obj({
