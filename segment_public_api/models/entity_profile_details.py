...
class EntityProfileDetails(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityProfileDetails:
        """Create an instance of EntityProfileDetails from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityProfileDetails:
        """Create an instance of EntityProfileDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityProfileDetails.parse_obj(obj)

        _obj = EntityProfileDetails.parse_obj({
            "id": obj.get("id"),
