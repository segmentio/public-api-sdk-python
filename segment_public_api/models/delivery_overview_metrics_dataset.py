...
class DeliveryOverviewMetricsDataset(BaseModel):
    """
    Dataset within GetDeliveryOverviewMetricsAlphaOutput.  # noqa: E501
    """
    event_name: Optional[StrictStr] = Field(None, alias="eventName", description="The name of the event if groupBy[] included 'eventName' in the request.")
    app_version: Optional[StrictStr] = Field(None, alias="appVersion", description="The version of the app if groupBy[] included 'appVersion' in the request.")
    event_type: Optional[StrictStr] = Field(None, alias="eventType", description="The event type if groupBy[] included 'eventType' in the request.")
    discard_reason: Optional[StrictStr] = Field(None, alias="discardReason", description="The discard reason for dropped events if groupBy[] included 'discardReason' in the request.")
    total: Union[StrictFloat, StrictInt] = Field(..., description="Holds the count of all event counts over the timeframe of the series.")
    series: conlist(DeliveryOverviewMetricsDatapoint) = Field(..., description="A list of the event counts broken down by the requested granularity, timeframe, and groupBy options.")
