...
class CreateAudienceAlphaInput(BaseModel):
    ...
    definition: AudienceDefinition = Field(description="Query language definition and type.")
    audience_type: StrictStr = Field(description="Denotes the type of audience product.  Possible values: USERS, ACCOUNTS.", alias="audienceType")
