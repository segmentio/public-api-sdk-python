...
class PreviewAudienceInput(BaseModel):
    """
    Input to preview an audience.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreviewAudienceInput:
        """Create an instance of PreviewAudienceInput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreviewAudienceInput:
        """Create an instance of PreviewAudienceInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreviewAudienceInput.parse_obj(obj)

        _obj = PreviewAudienceInput.parse_obj({
