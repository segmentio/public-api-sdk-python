...
class CreateAudienceOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAudienceOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAudienceOutput:
        """Create an instance of CreateAudienceOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAudienceOutput.parse_obj(obj)

        _obj = CreateAudienceOutput.parse_obj({
