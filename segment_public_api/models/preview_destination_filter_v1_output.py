...
class PreviewDestinationFilterV1Output(BaseModel):
    ...
    """ # noqa: E501
    input_payload: Dict[str, Any] = Field(description="The pre-filter JSON input.", alias="inputPayload")
    result: Optional[Dict[str, Any]] = Field(description="The filtered JSON output.")
    __properties: ClassVar[List[str]] = ["inputPayload", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputPayload": obj.get("inputPayload"),
