...
class ListWarehousesV1Output(BaseModel):
    """
    Returns a list of Warehouses that belong to a Workspace.  # noqa: E501
    """
    warehouses: conlist(WarehouseV1) = Field(..., description="A list of Warehouses that belong to the Workspace.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWarehousesV1Output:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWarehousesV1Output:
        """Create an instance of ListWarehousesV1Output from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWarehousesV1Output.parse_obj(obj)

        _obj = ListWarehousesV1Output.parse_obj({
