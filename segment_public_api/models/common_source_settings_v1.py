...
class CommonSourceSettingsV1(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommonSourceSettingsV1:
        """Create an instance of CommonSourceSettingsV1 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommonSourceSettingsV1:
        """Create an instance of CommonSourceSettingsV1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommonSourceSettingsV1.parse_obj(obj)

        _obj = CommonSourceSettingsV1.parse_obj({
