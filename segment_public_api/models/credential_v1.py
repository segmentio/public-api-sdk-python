...
class CredentialV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "workspaceId", "name", "settings", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CredentialV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CredentialV1 from a dict"""
        if obj is None:
            return None
