...
class ComputedTraitsDefinition(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ComputedTraitsDefinition:
        """Create an instance of ComputedTraitsDefinition from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ComputedTraitsDefinition:
        """Create an instance of ComputedTraitsDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ComputedTraitsDefinition.parse_obj(obj)

        _obj = ComputedTraitsDefinition.parse_obj({
            "query": obj.get("query"),
            "type": obj.get("type")
        })
        return _obj
