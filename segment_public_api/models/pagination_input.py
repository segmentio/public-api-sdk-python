...
class PaginationInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginationInput:
        """Create an instance of PaginationInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginationInput.parse_obj(obj)

        _obj = PaginationInput.parse_obj({
