...
class PaginationInput(BaseModel):
    ...
    """ # noqa: E501
    cursor: Optional[StrictStr] = Field(default=None, description="The page to request.  Acceptable values to use here are in PaginationOutput objects, in the `current`, `next`, and `previous` keys.  Consumers of the API must treat this value as opaque.")
    count: StrictInt = Field(description="The number of items to retrieve in a page, between 1 and 1000.")
    __properties: ClassVar[List[str]] = ["cursor", "count"]
