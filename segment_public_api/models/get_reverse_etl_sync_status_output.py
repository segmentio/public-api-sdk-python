...
class GetReverseETLSyncStatusOutput(BaseModel):
    ...
    """ # noqa: E501
    reverse_etl_sync_status: ReverseETLSyncStatus = Field(description="The status of the reverse ETL connection job.", alias="reverseETLSyncStatus")
    __properties: ClassVar[List[str]] = ["reverseETLSyncStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reverseETLSyncStatus": ReverseETLSyncStatus.from_dict(obj["reverseETLSyncStatus"]) if obj.get("reverseETLSyncStatus") is not None else None
        })
        return _obj
