...
class UpdateSelectiveSyncForWarehouseV1Input(BaseModel):
    ...
    """ # noqa: E501
    sync_overrides: List[WarehouseSyncOverrideV1] = Field(description="A list of sync schema overrides to apply to this Warehouse.", alias="syncOverrides")
    __properties: ClassVar[List[str]] = ["syncOverrides"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "syncOverrides": [WarehouseSyncOverrideV1.from_dict(_item) for _item in obj["syncOverrides"]] if obj.get("syncOverrides") is not None else None
        })
        return _obj
