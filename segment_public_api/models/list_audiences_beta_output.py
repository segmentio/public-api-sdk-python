...
class ListAudiencesBetaOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAudiencesBetaOutput:
        """Create an instance of ListAudiencesBetaOutput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAudiencesBetaOutput:
        """Create an instance of ListAudiencesBetaOutput from a dict"""
        if obj is None:
            return None
