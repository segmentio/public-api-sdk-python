...
class MinimalUserV1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MinimalUserV1:
        """Create an instance of MinimalUserV1 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MinimalUserV1:
        """Create an instance of MinimalUserV1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MinimalUserV1.parse_obj(obj)

        _obj = MinimalUserV1.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "email": obj.get("email")
        })
