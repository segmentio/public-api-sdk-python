...
class ListFiltersFromDestinationV1Output(BaseModel):
    ...
    """ # noqa: E501
    filters: List[DestinationFilterV1] = Field(description="A list of the filters that belong to the specified Destination instance.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [DestinationFilterV1.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
