...
class AdvancedWarehouseSyncScheduleV1Output(BaseModel):
    ...
    """ # noqa: E501
    times: Optional[List[WarehouseAdvancedSyncV1]] = Field(default=None, description="A list that contains the times when syncs should occur.")
    timezone: Optional[StrictStr] = Field(default=None, description="A TZ-database timezone for this sync schedule.")
    __properties: ClassVar[List[str]] = ["times", "timezone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "times": [WarehouseAdvancedSyncV1.from_dict(_item) for _item in obj["times"]] if obj.get("times") is not None else None,
