...
class AudiencePreviewAnyOf1(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudiencePreviewAnyOf1:
        """Create an instance of AudiencePreviewAnyOf1 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudiencePreviewAnyOf1:
        """Create an instance of AudiencePreviewAnyOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudiencePreviewAnyOf1.parse_obj(obj)

        _obj = AudiencePreviewAnyOf1.parse_obj({
