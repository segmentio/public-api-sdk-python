...
class DestinationSubscriptionUpdateInput(BaseModel):
    ...
    reverse_etl_model_id: Optional[StrictStr] = Field(None, alias="reverseETLModelId", description="(Reverse ETL only) The reverse ETL model to attach this subscription to.")
    reverse_etl_schedule: Optional[ReverseEtlScheduleDefinition] = Field(None, alias="reverseETLSchedule")
    __properties = ["name", "trigger", "enabled", "settings", "reverseETLModelId", "reverseETLSchedule"]
    ...
    def from_dict(cls, obj: dict) -> DestinationSubscriptionUpdateInput:
        ...
        _obj = DestinationSubscriptionUpdateInput.parse_obj({
            ...
            "reverse_etl_model_id": obj.get("reverseETLModelId"),
