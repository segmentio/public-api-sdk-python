...
class UpdateFunctionV1Input(BaseModel):
    ...
    logo_url: Optional[StrictStr] = Field(default=None, description="A logo for this Function.", alias="logoUrl")
    description: Optional[StrictStr] = Field(default=None, description="A description for this Function.")
    __properties: ClassVar[List[str]] = ["code", "settings", "displayName", "logoUrl", "description"]
