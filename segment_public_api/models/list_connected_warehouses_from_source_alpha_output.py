...
class ListConnectedWarehousesFromSourceAlphaOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListConnectedWarehousesFromSourceAlphaOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListConnectedWarehousesFromSourceAlphaOutput:
        """Create an instance of ListConnectedWarehousesFromSourceAlphaOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListConnectedWarehousesFromSourceAlphaOutput.parse_obj(obj)

        _obj = ListConnectedWarehousesFromSourceAlphaOutput.parse_obj({
