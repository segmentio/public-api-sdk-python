...
class ActionDefinition(BaseModel):
    ...
    use_default_mappings: Optional[StrictBool] = Field(None, alias="useDefaultMappings")
    mappings: Dict[str, Any] = Field(...)
    action_id: StrictStr = Field(..., alias="actionId")
    enabled: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    __properties = ["id", "useDefaultMappings", "mappings", "actionId", "enabled", "name"]
    ...
    def from_dict(cls, obj: dict) -> ActionDefinition:
        ...
        _obj = ActionDefinition.parse_obj({
            "id": obj.get("id"),
            "use_default_mappings": obj.get("useDefaultMappings"),
