...
class ListSelectiveSyncsFromWarehouseAndSourceV1Output(BaseModel):
    ...
    """ # noqa: E501
    items: List[WarehouseSelectiveSyncItemV1] = Field(description="Represents a list of Source, collection, and properties synced to the Warehouse.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [WarehouseSelectiveSyncItemV1.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
