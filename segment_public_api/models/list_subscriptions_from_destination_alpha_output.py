...
class ListSubscriptionsFromDestinationAlphaOutput(BaseModel):
    ...
    """ # noqa: E501
    subscriptions: List[DestinationSubscription] = Field(description="A list of Destination subscriptions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptions": [DestinationSubscription.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None,
