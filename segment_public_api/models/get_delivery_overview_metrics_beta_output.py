...
class GetDeliveryOverviewMetricsBetaOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDeliveryOverviewMetricsBetaOutput:
        """Create an instance of GetDeliveryOverviewMetricsBetaOutput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDeliveryOverviewMetricsBetaOutput:
        """Create an instance of GetDeliveryOverviewMetricsBetaOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDeliveryOverviewMetricsBetaOutput.parse_obj(obj)

        _obj = GetDeliveryOverviewMetricsBetaOutput.parse_obj({
            "total": obj.get("total"),
