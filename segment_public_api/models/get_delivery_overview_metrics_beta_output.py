...
class GetDeliveryOverviewMetricsBetaOutput(BaseModel):
    ...
    dataset: List[DeliveryOverviewMetricsDataset] = Field(description="Represents the list of series broken down by the dimensions and time frame requested.")
    pagination: PaginationOutput = Field(description="The result object used to specify the page cursor and count.")
    __properties: ClassVar[List[str]] = ["total", "dataset", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "dataset": [DeliveryOverviewMetricsDataset.from_dict(_item) for _item in obj["dataset"]] if obj.get("dataset") is not None else None,
