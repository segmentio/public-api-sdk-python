...
class ListProfilesWarehouseInSpaceAlphaOutput(BaseModel):
    ...
    """ # noqa: E501
    profiles_warehouses: List[ProfilesWarehouseAlpha] = Field(description="A list of Warehouses that belong to the Workspace.", alias="profilesWarehouses")
    pagination: Optional[PaginationOutput] = Field(default=None, description="Information about the pagination of this response.")
    __properties: ClassVar[List[str]] = ["profilesWarehouses", "pagination"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.profiles_warehouses:
            for _item_profiles_warehouses in self.profiles_warehouses:
                if _item_profiles_warehouses:
                    _items.append(_item_profiles_warehouses.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profilesWarehouses": [ProfilesWarehouseAlpha.from_dict(_item) for _item in obj["profilesWarehouses"]] if obj.get("profilesWarehouses") is not None else None,
