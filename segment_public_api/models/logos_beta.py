...
class LogosBeta(BaseModel):
    ...
    mark: Optional[StrictStr] = Field(default=None, description="The logo mark.")
    alt: Optional[StrictStr] = Field(default=None, description="The alternative text for this logo.")
    __properties: ClassVar[List[str]] = ["default", "mark", "alt"]
