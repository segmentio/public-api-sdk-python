...
class DestinationState(BaseModel):
    ...
    key: Key = Field(...)
    __properties = ["type", "destinations", "transitions", "key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DestinationState:
        """Create an instance of DestinationState from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DestinationState:
        """Create an instance of DestinationState from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DestinationState.parse_obj(obj)

        _obj = DestinationState.parse_obj({
            "type": obj.get("type"),
