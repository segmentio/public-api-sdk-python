...
class UpdateAudienceScheduleForAudienceInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateAudienceScheduleForAudienceInput:
        """Create an instance of UpdateAudienceScheduleForAudienceInput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateAudienceScheduleForAudienceInput:
        """Create an instance of UpdateAudienceScheduleForAudienceInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateAudienceScheduleForAudienceInput.parse_obj(obj)

        _obj = UpdateAudienceScheduleForAudienceInput.parse_obj({
