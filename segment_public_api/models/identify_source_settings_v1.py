...
class IdentifySourceSettingsV1(BaseModel):
    ...
    """ # noqa: E501
    allow_unplanned_traits: Optional[StrictBool] = Field(default=None, description="Enable to allow unplanned identify traits.  Config API note: equal to `allowUnplannedIdentifyTraits`.", alias="allowUnplannedTraits")
    allow_traits_on_violations: Optional[StrictBool] = Field(default=None, description="Enable to allow identify traits on violations.  Config API note: equal to `allowIdentifyTraitsOnViolations`.", alias="allowTraitsOnViolations")
    common_event_on_violations: Optional[StrictStr] = Field(default=None, description="The common identify event on violations.  Config API note: equal to `commonIdentifyEventOnViolations`.", alias="commonEventOnViolations")
