...
class CreateEdgeFunctionsAlphaOutput(BaseModel):
    """
    Output for CreateEdgeFunctions.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateEdgeFunctionsAlphaOutput:
        """Create an instance of CreateEdgeFunctionsAlphaOutput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateEdgeFunctionsAlphaOutput:
        """Create an instance of CreateEdgeFunctionsAlphaOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateEdgeFunctionsAlphaOutput.parse_obj(obj)

        _obj = CreateEdgeFunctionsAlphaOutput.parse_obj({
