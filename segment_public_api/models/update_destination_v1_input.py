...
class UpdateDestinationV1Input(BaseModel):
    ...
    settings: Optional[Dict[str, Any]] = Field(default=None, description="An optional object that contains settings for the Destination based on the \"required\" and \"advanced\" settings present in the Destination metadata.  Config API note: equal to `config`.")
    __properties: ClassVar[List[str]] = ["name", "enabled", "settings"]
