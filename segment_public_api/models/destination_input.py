...
class DestinationInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DestinationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DestinationInput:
        """Create an instance of DestinationInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DestinationInput.parse_obj(obj)

        _obj = DestinationInput.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
