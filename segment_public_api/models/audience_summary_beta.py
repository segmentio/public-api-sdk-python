...
class AudienceSummaryBeta(BaseModel):
    """
    ...
    definition: Optional[AudienceDefinitionBeta] = Field(...)
    ...
    options: Optional[AudienceOptionsBeta] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudienceSummaryBeta:
        """Create an instance of AudienceSummaryBeta from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudienceSummaryBeta:
        """Create an instance of AudienceSummaryBeta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudienceSummaryBeta.parse_obj(obj)

        _obj = AudienceSummaryBeta.parse_obj({
            "id": obj.get("id"),
            ...
            "definition": AudienceDefinitionBeta.from_dict(obj.get("definition")) if obj.get("definition") is not None else None,
            "status": obj.get("status"),
            "created_by": obj.get("createdBy"),
            "updated_by": obj.get("updatedBy"),
            "created_at": obj.get("createdAt"),
            "updated_at": obj.get("updatedAt"),
            "options": AudienceOptionsBeta.from_dict(obj.get("options")) if obj.get("options") is not None else None
        })
        return _obj
