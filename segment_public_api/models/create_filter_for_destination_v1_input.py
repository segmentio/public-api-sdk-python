...
class CreateFilterForDestinationV1Input(BaseModel):
    ...
    var_if: StrictStr = Field(description="The filter's condition.", alias="if")
    actions: List[DestinationFilterActionV1] = Field(description="Actions for the Destination filter.")
    ...
    __properties: ClassVar[List[str]] = ["sourceId", "if", "actions", "title", "description", "enabled"]
