...
class TransformationBeta(BaseModel):
    ...
    __properties = ["id", "name", "sourceId", "destinationMetadataId", "enabled", "if", "newEventName", "propertyRenames", "propertyValueTransformations"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransformationBeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransformationBeta:
        """Create an instance of TransformationBeta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransformationBeta.parse_obj(obj)

        _obj = TransformationBeta.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
