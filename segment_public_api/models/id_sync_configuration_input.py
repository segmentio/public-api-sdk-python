...
class IDSyncConfigurationInput(BaseModel):
    ...
    """ # noqa: E501
    external_id: StrictStr = Field(description="The id type to sync. Examples: user_id, email, anonymous_id.", alias="externalId")
    ...
    map_to: Optional[StrictStr] = Field(default=None, description="Optional destination-specific identifier to map to (for example, \"Email_Address_c\").", alias="mapTo")
    __properties: ClassVar[List[str]] = ["externalId", "strategy", "mapTo"]
