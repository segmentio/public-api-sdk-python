...
class PreviewAudienceOutput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreviewAudienceOutput:
        """Create an instance of PreviewAudienceOutput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreviewAudienceOutput:
        """Create an instance of PreviewAudienceOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreviewAudienceOutput.parse_obj(obj)

        _obj = PreviewAudienceOutput.parse_obj({
