...
class UpdateAudienceScheduleForAudienceAlphaInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateAudienceScheduleForAudienceAlphaInput:
        """Create an instance of UpdateAudienceScheduleForAudienceAlphaInput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateAudienceScheduleForAudienceAlphaInput:
        """Create an instance of UpdateAudienceScheduleForAudienceAlphaInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateAudienceScheduleForAudienceAlphaInput.parse_obj(obj)

        _obj = UpdateAudienceScheduleForAudienceAlphaInput.parse_obj({
