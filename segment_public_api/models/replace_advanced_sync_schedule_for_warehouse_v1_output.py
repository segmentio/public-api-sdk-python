...
class ReplaceAdvancedSyncScheduleForWarehouseV1Output(BaseModel):
    ...
    schedule: Optional[AdvancedWarehouseSyncScheduleV1Output] = Field(default=None, description="The schedule that contains the overrides for the Warehouse, if enabled.")
