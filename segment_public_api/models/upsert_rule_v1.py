...
class UpsertRuleV1(BaseModel):
    ...
    UpsertRuleV1
    """ # noqa: E501
    new_key: Optional[StrictStr] = Field(default=None, description="This rule's new intended key.", alias="newKey")
    ...
    __properties: ClassVar[List[str]] = ["newKey", "type", "key", "jsonSchema", "version"]
