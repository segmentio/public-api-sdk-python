...
class CreateReverseETLManualSyncOutput(BaseModel):
    ...
    """ # noqa: E501
    reverse_etl_manual_sync: ReverseETLManualSyncJobOutput = Field(description="The reverse ETL connection job that was manually started.", alias="reverseETLManualSync")
    __properties: ClassVar[List[str]] = ["reverseETLManualSync"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reverseETLManualSync": ReverseETLManualSyncJobOutput.from_dict(obj["reverseETLManualSync"]) if obj.get("reverseETLManualSync") is not None else None
        })
        return _obj
