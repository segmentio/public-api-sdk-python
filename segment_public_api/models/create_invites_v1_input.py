...
class CreateInvitesV1Input(BaseModel):
    ...
    """ # noqa: E501
    invites: List[InviteV1] = Field(description="The list of invites.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invites": [InviteV1.from_dict(_item) for _item in obj["invites"]] if obj.get("invites") is not None else None
        })
        return _obj
