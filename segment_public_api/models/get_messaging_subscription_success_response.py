...
class GetMessagingSubscriptionSuccessResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The user subscribed, unsubscribed, or on initial status. This is absent if the phone number or email is not found.")
    groups: Optional[List[GroupSubscriptionStatusResponse]] = Field(default=None, description="Optional subscription groups.")
    updated_at: Optional[StrictStr] = Field(default=None, description="The timestamp of this subscription status's last change.", alias="updatedAt")
    __properties: ClassVar[List[str]] = ["key", "type", "status", "groups", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [GroupSubscriptionStatusResponse.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
