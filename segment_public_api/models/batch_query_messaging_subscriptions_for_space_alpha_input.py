...
class BatchQueryMessagingSubscriptionsForSpaceAlphaInput(BaseModel):
    ...
    Batch get request.
    """ # noqa: E501
    subscriptions: List[GetSubscriptionRequest] = Field(description="A list of subscriptions to retrieve subscription status.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptions": [GetSubscriptionRequest.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
        return _obj
