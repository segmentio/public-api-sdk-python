...
class AddAudienceScheduleToAudience200Response(BaseModel):
    ...
    """
    data: Optional[AddAudienceScheduleToAudienceOutput] = None
    __properties = ["data"]
    ...
    def from_dict(cls, obj: dict) -> AddAudienceScheduleToAudience200Response:
        ...
        _obj = AddAudienceScheduleToAudience200Response.parse_obj({
            "data": AddAudienceScheduleToAudienceOutput.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
