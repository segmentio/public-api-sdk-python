...
class CreateTransformationV1Input(BaseModel):
    ...
    fql_defined_properties: Optional[List[FQLDefinedPropertyV1]] = Field(default=None, description="Optional array for defining new properties in [FQL](https://segment.com/docs/config-api/fql/). Currently limited to 1 property.", alias="fqlDefinedProperties")
