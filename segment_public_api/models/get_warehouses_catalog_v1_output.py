...
class GetWarehousesCatalogV1Output(BaseModel):
    ...
    """ # noqa: E501
    warehouses_catalog: List[WarehouseMetadataV1] = Field(description="All Warehouse catalog items contained within the requested page.", alias="warehousesCatalog")
    pagination: PaginationOutput = Field(description="Information about the pagination of this response.")
    __properties: ClassVar[List[str]] = ["warehousesCatalog", "pagination"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.warehouses_catalog:
            for _item_warehouses_catalog in self.warehouses_catalog:
                if _item_warehouses_catalog:
                    _items.append(_item_warehouses_catalog.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "warehousesCatalog": [WarehouseMetadataV1.from_dict(_item) for _item in obj["warehousesCatalog"]] if obj.get("warehousesCatalog") is not None else None,
