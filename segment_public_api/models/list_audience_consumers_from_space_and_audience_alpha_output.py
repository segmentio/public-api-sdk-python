...
class ListAudienceConsumersFromSpaceAndAudienceAlphaOutput(BaseModel):
    ...
    """ # noqa: E501
    audiences: List[AudienceSummary] = Field(description="The list of audience consumers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audiences": [AudienceSummary.from_dict(_item) for _item in obj["audiences"]] if obj.get("audiences") is not None else None,
