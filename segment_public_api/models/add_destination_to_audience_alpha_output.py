...
class AddDestinationToAudienceAlphaOutput(BaseModel):
    ...
    id_sync_configuration: List[IDSyncConfigurationInput] = Field(description="Identifier sync configuration. Defines which external ids to sync and their selection strategies. Maximum 5 items allowed. If omitted, the default will be last email and last user_id, or all email and all user_id depending on the Destination.", alias="idSyncConfiguration")
    ...
    __properties: ClassVar[List[str]] = ["connection", "idSyncConfiguration", "connectionSettings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddDestinationToAudienceAlphaOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddDestinationToAudienceAlphaOutput from a dict"""
        if obj is None:
            return None
