...
class UpdateActivationForAudienceAlphaInput(BaseModel):
    ...
    activation_name: Optional[StrictStr] = Field(default=None, description="Activation name. For Warehouse Destinations, this is used as the table name. Omit this field to leave the name unchanged. An empty string is ignored rather than applied.", alias="activationName")
