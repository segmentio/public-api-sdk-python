...
class GetComputedTraitAlphaOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetComputedTraitAlphaOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetComputedTraitAlphaOutput:
        """Create an instance of GetComputedTraitAlphaOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetComputedTraitAlphaOutput.parse_obj(obj)

        _obj = GetComputedTraitAlphaOutput.parse_obj({
