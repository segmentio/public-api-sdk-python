...
class ListActivationsFromAudienceOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListActivationsFromAudienceOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListActivationsFromAudienceOutput:
