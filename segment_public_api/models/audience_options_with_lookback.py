...
class AudienceOptionsWithLookback(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudienceOptionsWithLookback:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudienceOptionsWithLookback:
        """Create an instance of AudienceOptionsWithLookback from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudienceOptionsWithLookback.parse_obj(obj)
