...
class UsersPerSourceSnapshotV1(BaseModel):
    """
    A snapshot of MTU metrics for a given Source within the given usage period.  # noqa: E501
    """
    ...
    __properties = ["sourceId", "periodStart", "periodEnd", "anonymous", "anonymousIdentified", "identified", "neverIdentified", "timestamp"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsersPerSourceSnapshotV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsersPerSourceSnapshotV1:
        """Create an instance of UsersPerSourceSnapshotV1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsersPerSourceSnapshotV1.parse_obj(obj)

        _obj = UsersPerSourceSnapshotV1.parse_obj({
