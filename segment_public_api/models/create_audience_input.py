...
class CreateAudienceInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAudienceInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAudienceInput:
        """Create an instance of CreateAudienceInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAudienceInput.parse_obj(obj)

        _obj = CreateAudienceInput.parse_obj({
            "name": obj.get("name"),
