...
class SpecificDaysConfig(BaseModel):
    ...
    """ # noqa: E501
    days: List[Union[StrictFloat, StrictInt]] = Field(description="Days of week for schedule (0=Sunday, 6=Saturday).")
    hours: List[Union[StrictFloat, StrictInt]] = Field(description="Hours of day for schedule (0-23).")
    timezone: StrictStr = Field(description="TZ database time zone identifier; for example, America/New_York.")
    __properties: ClassVar[List[str]] = ["days", "hours", "timezone"]
