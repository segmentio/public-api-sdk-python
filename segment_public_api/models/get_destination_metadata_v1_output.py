...
class GetDestinationMetadataV1Output(BaseModel):
    ...
    """ # noqa: E501
    destination_metadata: DestinationMetadataV1 = Field(description="The catalog item matched by id.", alias="destinationMetadata")
    __properties: ClassVar[List[str]] = ["destinationMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destinationMetadata": DestinationMetadataV1.from_dict(obj["destinationMetadata"]) if obj.get("destinationMetadata") is not None else None
        })
        return _obj
