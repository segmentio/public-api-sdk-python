...
class AddDestinationToAudienceAlphaInput(BaseModel):
    ...
    """ # noqa: E501
    destination: DestinationInput = Field(description="The Destination.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destination": DestinationInput.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
