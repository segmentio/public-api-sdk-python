...
class InsertFunctionInstanceAlpha(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "integrationId", "classId", "enabled", "createdAt", "updatedAt", "settings", "encryptedSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "encryptedSettings": obj.get("encryptedSettings")
        })
        return _obj
