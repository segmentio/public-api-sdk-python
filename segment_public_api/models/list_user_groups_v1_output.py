...
class ListUserGroupsV1Output(BaseModel):
    ...
    """ # noqa: E501
    user_groups: List[UserGroupV1] = Field(description="The user group returned from the query.", alias="userGroups")
    pagination: PaginationOutput = Field(description="Information about the pagination of this response.")
    __properties: ClassVar[List[str]] = ["userGroups", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userGroups": [UserGroupV1.from_dict(_item) for _item in obj["userGroups"]] if obj.get("userGroups") is not None else None,
