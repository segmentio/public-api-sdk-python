...
class ListWorkspaceRegulationsV1Output(BaseModel):
    """
    Output of all Workspace-scoped regulations in a given Workspace.  # noqa: E501
    """
    ...
    __properties = ["regulations", "pagination"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWorkspaceRegulationsV1Output:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWorkspaceRegulationsV1Output:
        """Create an instance of ListWorkspaceRegulationsV1Output from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWorkspaceRegulationsV1Output.parse_obj(obj)

        _obj = ListWorkspaceRegulationsV1Output.parse_obj({
