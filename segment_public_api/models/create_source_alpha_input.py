...
class CreateSourceAlphaInput(BaseModel):
    ...
    name: Optional[StrictStr] = Field(None, description="An optional human-readable name for this Source.")
    ...
    __properties = ["slug", "enabled", "name", "metadataId", "settings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSourceAlphaInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSourceAlphaInput:
        """Create an instance of CreateSourceAlphaInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSourceAlphaInput.parse_obj(obj)

        _obj = CreateSourceAlphaInput.parse_obj({
            "slug": obj.get("slug"),
