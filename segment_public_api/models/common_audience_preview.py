...
class CommonAudiencePreview(BaseModel):
    """
    Fields common to an audience preview regardless of the status.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommonAudiencePreview:
        """Create an instance of CommonAudiencePreview from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommonAudiencePreview:
        """Create an instance of CommonAudiencePreview from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommonAudiencePreview.parse_obj(obj)

        _obj = CommonAudiencePreview.parse_obj({
            "id": obj.get("id"),
