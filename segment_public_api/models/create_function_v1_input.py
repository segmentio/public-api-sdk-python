...
class CreateFunctionV1Input(BaseModel):
    ...
    display_name: StrictStr = Field(description="A display name for this Function.  Note that Destination Functions append the Workspace to the display name.", alias="displayName")
    logo_url: Optional[StrictStr] = Field(default=None, description="The URL of the logo for this Function.", alias="logoUrl")
    resource_type: StrictStr = Field(description="The Function type.  Config API note: equal to `type`.", alias="resourceType")
    description: Optional[StrictStr] = Field(default=None, description="A description for this Function.")
    __properties: ClassVar[List[str]] = ["code", "settings", "displayName", "logoUrl", "resourceType", "description"]
