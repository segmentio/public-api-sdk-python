...
class CreateWorkspaceRegulationV1Input(BaseModel):
    """
    The input to create a Workspace regulation.  # noqa: E501
    """
    regulation_type: StrictStr = Field(..., alias="regulationType", description="The regulation type to create.")
    subject_type: StrictStr = Field(..., alias="subjectType", description="The subject type. Use `objectId` for Cloud Source regulations.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateWorkspaceRegulationV1Input:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateWorkspaceRegulationV1Input:
        """Create an instance of CreateWorkspaceRegulationV1Input from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateWorkspaceRegulationV1Input.parse_obj(obj)

        _obj = CreateWorkspaceRegulationV1Input.parse_obj({
