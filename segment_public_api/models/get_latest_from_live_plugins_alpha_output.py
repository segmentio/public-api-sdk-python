...
class GetLatestFromLivePluginsAlphaOutput(BaseModel):
    ...
    """ # noqa: E501
    live_plugin: LivePluginsAlpha = Field(description="The latest version of Live Plugin bundle.", alias="livePlugin")
    __properties: ClassVar[List[str]] = ["livePlugin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "livePlugin": LivePluginsAlpha.from_dict(obj["livePlugin"]) if obj.get("livePlugin") is not None else None
        })
        return _obj
