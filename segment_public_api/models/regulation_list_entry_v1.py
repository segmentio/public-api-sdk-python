...
class RegulationListEntryV1(BaseModel):
    ...
    subject_type: StrictStr = Field(description="The subject type.", alias="subjectType")
    subjects: List[StrictStr] = Field(description="The list of `userId` or `objectId` values of the subjects to regulate.")
    ...
    regulation_type: StrictStr = Field(description="The regulation type.", alias="regulationType")
    ...
    __properties: ClassVar[List[str]] = ["id", "subjectType", "subjects", "status", "createdAt", "regulationType", "finishedAt"]
