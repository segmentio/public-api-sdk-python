...
class ListInsertFunctionInstancesAlphaOutput(BaseModel):
    ...
    """ # noqa: E501
    instances: List[InsertFunctionInstanceAlpha] = Field(description="All insert Function instances found.")
    pagination: PaginationOutput = Field(description="Information about the pagination of this response.")
    __properties: ClassVar[List[str]] = ["instances", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": [InsertFunctionInstanceAlpha.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
