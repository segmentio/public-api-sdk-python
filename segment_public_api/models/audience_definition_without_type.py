...
class AudienceDefinitionWithoutType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudienceDefinitionWithoutType:
        """Create an instance of AudienceDefinitionWithoutType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudienceDefinitionWithoutType:
        """Create an instance of AudienceDefinitionWithoutType from a dict"""
        if obj is None:
            return None
