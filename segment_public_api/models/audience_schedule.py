...
class AudienceSchedule(BaseModel):
    ...
    enabled: StrictBool = Field(..., description="Whether the schedule is enabled.")
    next_execution: StrictStr = Field(..., alias="nextExecution", description="The next scheduled execution time (RFC3339).")
    __properties = ["id", "strategy", "config", "enabled", "nextExecution"]
