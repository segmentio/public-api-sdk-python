...
class AudienceSchedule(BaseModel):
    ...
    next_execution: Optional[StrictStr] = Field(default=None, description="The next scheduled execution time (RFC3339).", alias="nextExecution")
    __properties: ClassVar[List[str]] = ["id", "strategy", "config", "nextExecution"]
