...
class FailedAudiencePreview(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FailedAudiencePreview:
        """Create an instance of FailedAudiencePreview from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FailedAudiencePreview:
        """Create an instance of FailedAudiencePreview from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FailedAudiencePreview.parse_obj(obj)

        _obj = FailedAudiencePreview.parse_obj({
