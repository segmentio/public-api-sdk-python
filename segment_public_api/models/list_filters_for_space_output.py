...
class ListFiltersForSpaceOutput(BaseModel):
    ...
    """ # noqa: E501
    filters: Optional[List[Filter]] = Field(default=None, description="Filter output.")
    pagination: Optional[ListFiltersPaginationOutput] = Field(default=None, description="Pagination parameters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pagination": ListFiltersPaginationOutput.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
