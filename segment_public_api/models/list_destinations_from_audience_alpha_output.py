...
class ListDestinationsFromAudienceAlphaOutput(BaseModel):
    ...
    """ # noqa: E501
    connections: List[SimpleDestination] = Field(description="A list of connection results.")
    ...
    __properties: ClassVar[List[str]] = ["connections", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connections": [SimpleDestination.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None,
