...
class CreateReverseETLManualSyncInput(BaseModel):
    ...
    subscription_id: StrictStr = Field(description="The id of the Subscription.", alias="subscriptionId")
    __properties: ClassVar[List[str]] = ["sourceId", "modelId", "subscriptionId"]
